                        ...
                        <Collapse>
                            <CollapseHeader>
                                {room.title ? (
                                    <View
                                        key={room.id}
                                        className="flex-row justify-start rounded-[12px] bg-[#e6eff6] py-2  px-2 items-center "
                                        style={{ ro: 20 }}
                                    >
                                        <View className="w-[60px] h-[60px] rounded-full  bg-[#edf6fd] p-3 mr-3 object-cover">
                                            <Image
                                                source={boxIcon[data.title]}
                                    ...
                                    >
                                        ...
                                        <Text
                                            className="text-left justify-self-end flex-1 font-bold text-[16px] "
                                            numberOfLines={1}
                                            ellipsizeMode="tail"
                                        >
                                            {room.roomname}
                                    ...
                                    <View style={styles.contentContainer}>
                                        {room.roomNo?.map((rm) => (
                                            <Pressable
                                                ...
                                                className="flex-row items-center p-2 mb-2  bg-[#edf6fd] rounded-md"
                                            >
